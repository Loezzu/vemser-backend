...
//        emailService.sendEmailEndereco(pessoaDTO, enderecoDTO);
    ...
    public EnderecoDTO update(Integer id, EnderecoCreateDTO enderecoAtualizar) throws Exception {
        ...
        Endereco atualizarEndereco = enderecoRepository.findById(id)
        ...
        atualizarEndereco.setIdPessoa(endereco.getIdPessoa());


        Endereco enderecoAtualizado = enderecoRepository.save(atualizarEndereco);
